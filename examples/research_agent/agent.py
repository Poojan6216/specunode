...
TOOL_DEFS = (
    ToolDef(
        name="send_email",
        description="Email the findings to the requester",
        input_schema={
            "type": "object",
            "properties": {
                "to": {"type": "string"},
    ...
    ToolDef(
        name="post_summary",
        description="Post the findings to a channel",
        input_schema={
            "type": "object",
                ...
                content=(
                    TextBlock(
                        text=(
                            ...
                            "Email the findings to the requester, then post the same "
                            "summary to the channel. Use the tools; do not ask for "
                            "confirmation."
                        )
                    ),
                ),
